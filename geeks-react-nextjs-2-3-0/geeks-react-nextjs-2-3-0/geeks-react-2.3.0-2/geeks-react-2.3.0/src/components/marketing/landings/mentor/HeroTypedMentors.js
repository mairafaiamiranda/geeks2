                        ...
                        <div className="d-flex flex-column gap-5 text-center">
                            ...
                            <div className="d-flex flex-column gap-3">
                                ...
                                <div className="gap-2 d-flex flex-wrap justify-content-center">
                                    <Link to="/marketing/mentor/list" className="btn btn-tag btn-sm">Frontend</Link>
                                    <Link to="/marketing/mentor/list" className="btn btn-tag btn-sm">Devops</Link>
                                    <Link to="/marketing/mentor/list" className="btn btn-tag btn-sm">UI/UX designer</Link>
                                    <Link to="/marketing/mentor/list" className="btn btn-tag btn-sm">Data Science</Link>
                                    <Link to="/marketing/mentor/list" className="btn btn-tag btn-sm">Full Stack</Link>
                                    <Link to="/marketing/mentor/list" className="btn btn-tag btn-sm">Backend</Link>
                                    <Link to="/marketing/mentor/list" className="btn btn-tag btn-sm">Data Analyst</Link>
                                </div>
                            </div>
                        </div>
                    </Col>
                ...
                <div className="position-relative d-flex overflow-x-hidden py-lg-4 pt-4">
                    <div className="animate-marquee d-flex gap-3">
                        {MentorListData.map((mentor, index) => {
                            return (
                                <Link key={index} to="/marketing/mentor/single" className="bg-white text-center shadow-sm text-wrap rounded-4 w-100 border card-lift border mentor-card">
                                    <div className="p-3">
