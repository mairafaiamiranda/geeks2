...
const TestimonialModalPopup = (props) => {
    const testimonial = TestimonialsData.filter(
        (item) => item.id === props.activetestimonial
    )[0];
    return (
        <Modal {...props} aria-labelledby="contained-modal-title-vcenter" centered>
            ...
            <Modal.Body>
                <div className="mb-4">
                    <p
                        className="mb-0 fst-italic fs-4 pe-xxl-5"
                ...
                <div className="d-flex flex-xl-row gap-2 align-items-center bg-light rounded-pill px-3 py-2">
                    <Image
                        ...
                        alt="avatar 2"
                        className="avatar avatar-md rounded-circle d-lg-none d-md-block d-xl-block"
                    />
                    <div>
                        <div className="d-flex flex-row gap-2 align-items-center">
                            ...
                            <Badge
                                bg="success-subtle"
                                className="rounded-pill fs-6 px-2 text-success-emphasis border border-success"
                            >
                                Mentor
                            </Badge>
                        </div>
