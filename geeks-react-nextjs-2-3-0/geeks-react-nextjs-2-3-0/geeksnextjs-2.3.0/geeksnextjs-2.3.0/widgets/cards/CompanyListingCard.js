                ...
                <div>
                    <div className="d-lg-flex">
                        <div className="mb-3 mb-lg-0">
                            <Image src={item.logo} alt={item.company} className="icon-shape border rounded-3 icon-xxl" />
                        </div>
                        <div className="w-100 ms-lg-4">
                            <div className="d-flex justify-content-between mt-1">
                                <div>
                                    <h3 className="mb-1">
                                        <Link href="/marketing/jobs/company/about/" className="text-inherit">{item.company}</Link>
                                    </h3>
                                    <div>
                                        <span className="text-dark fw-medium">{item.rating} <svg xmlns="http://www.w3.org/2000/svg" width="10"
                                ...
                                <div>
                                    <Link href="#" className="btn btn-outline-primary btn-sm">Follow</Link>
                                </div>
                            </div>
                            <div>
                                <div className="mt-4">
                                    <Row className="row g-2">
                                        <Col md={6} xs={12}>
                                            <div><span><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                                                ...
                                                <span className="ms-1">{item.experience}</span></div>
                                        </Col>
                                        <Col md={6} xs={12}>
                                            <div> <span><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                                                ...
                                                <span className="ms-1">{item.location}</span></div>
                                        </Col>
                                        <Col md={6} xs={12}>
                                            <div><span><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                                                ...
                                                <span className="ms-1">{item.type}</span></div>
                                        </Col>
                                        <Col md={6} xs={12}>
                                            <div><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                ...
                                                <span className="ms-1">{item.employees} Employees ({item.country})</span></div>
                                        </Col>
                                    </Row>
                                    <div>
                                        <div className="mt-3">
