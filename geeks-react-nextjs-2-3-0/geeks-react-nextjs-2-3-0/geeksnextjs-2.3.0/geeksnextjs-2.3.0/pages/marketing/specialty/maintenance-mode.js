...
const MaintenanceMode = () => {
	return (
        <Fragment>
			{/* Geeks SEO settings  */}
			<GeeksSEO title="Maintenance Mode | Geeks Nextjs Template"/>
			...
			<Row className="align-items-center justify-content-center g-0 py-lg-22 py-10">
				...
				>
					...
					<p className="mb-5 fs-4">
						...
						<Link href="#">admin@company.com</Link>. We’ll be back up soon
					</p>
					<hr className="my-5" />
					<div>
						{/*  notify form */}
				...
				>
					<Image src="/images/background/maintenance-mode.svg" alt="" className="w-100" />
				</Col>
			</Row>
		</Fragment>
    );
...
MaintenanceMode.Layout = NotFound;
