                    ...
                    <Row className="mt-16">
                            ...
                            <div className="mb-6">
                                <div className="img-overlay">
                                    <div className="img-color">
                                        <Link href="/marketing/portfolio/single/">
                                            <Image src={'/images/portfolio/portfolio-square-1.jpg'} alt="portfolio" className="img-fluid w-100" />
                                        </Link>
                                        <div className="caption">
                                            <Link href="/marketing/portfolio/single/" className="btn btn-white">View Details</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-4">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <h3 className="fw-semibold mb-1"><Link href="/marketing/portfolio/single/" className="text-inherit">Business Card</Link></h3>
                                        <Link href="/marketing/portfolio/single/"><ArrowUpRight size={14} fill="currentColor" /></Link>
                                    </div>
                        ...
                        <Col md={6}>
                            <div className="mb-6">
                                ...
                                <div className="mt-4">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <h3 className="fw-semibold mb-1"><Link href="/marketing/portfolio/single/" className="text-inherit">Hello Summer</Link></h3>
                                        <Link href="/marketing/portfolio/single/"><ArrowUpRight size={14} fill="currentColor" /></Link>
                                    </div>
                                    <span>Website / UX/UI / Development</span>
                                </div>
