...
import { GeeksSEO, PageHeadingBriefinfo, CourseCard }  from 'widgets';

// import sub components
import { PopularInstructorCard }  from 'sub-components';
...
const CourseCategory = () => {
	return (
		<Fragment>
			{/* Geeks SEO settings  */}
			<GeeksSEO title="Course Category | JavaScript Courses | Geeks Nextjs Template"/>
