...
import { CompanyListingCard, GeeksSEO } from 'widgets';

// import sub components 
import { JobSearchBox, CompanyFilters } from 'sub-components';
...
const CompanyList = () => {
  ...
  return (
    <Fragment>
      {/* Geeks SEO settings  */}
      <GeeksSEO title="Company List | Jobs | Geeks Nextjs Template" />
...
CompanyList.Layout = JobListingLayout;
