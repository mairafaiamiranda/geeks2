...
import { BasicDetails, Employment, Education, Job } from 'sub-components';
...
const UploadResume = () => {
  ...
  return (
    <Fragment>
      {/* Geeks SEO settings  */}
      <GeeksSEO title="Upload Resume | Jobs | Geeks Nextjs Template" />
...
UploadResume.Layout = JobListingLayout;
