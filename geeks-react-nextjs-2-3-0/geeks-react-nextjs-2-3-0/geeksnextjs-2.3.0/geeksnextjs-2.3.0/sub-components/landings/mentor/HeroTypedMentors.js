                    ...
                    <Col xxl={5} xl={6} md={10}>
                        <div className="d-flex flex-column gap-5 text-center">
                            <div className="d-flex flex-column gap-2">
                                <span className="text-dark fs-5">Learn a new skill, launch a project, land your dream career.</span>
                                <h1 className="mb-0 display-2 fw-bold">
                                    <span>1-on-1</span>{' '}
                                    <span className="headingTyped text-primary" >
                                        <Typewriter
                                            words={['Javascript', 'Startup', 'React', 'Marketing', 'Branding']}
                                            loop
                                            cursor
                                            cursorStyle='|'
                                            typeSpeed={60}
                            ...
                            <div className="d-flex flex-column gap-3">
                                ...
                                <div className="gap-2 d-flex flex-wrap justify-content-center">
                                    <Link href="/marketing/mentor/list" className="btn btn-tag btn-sm">Frontend</Link>
                                    <Link href="/marketing/mentor/list" className="btn btn-tag btn-sm">Devops</Link>
                                    <Link href="/marketing/mentor/list" className="btn btn-tag btn-sm">UI/UX designer</Link>
                                    <Link href="/marketing/mentor/list" className="btn btn-tag btn-sm">Data Science</Link>
                                    <Link href="/marketing/mentor/list" className="btn btn-tag btn-sm">Full Stack</Link>
                                    <Link href="/marketing/mentor/list" className="btn btn-tag btn-sm">Backend</Link>
                                    <Link href="/marketing/mentor/list" className="btn btn-tag btn-sm">Data Analyst</Link>
                                </div>
                            </div>
                        </div>
                    </Col>
            ...
            <div>
                <div className="position-relative d-flex overflow-x-hidden py-lg-4 pt-4">
                    <div className="animate-marquee d-flex gap-3">
                        {MentorListData.map((mentor, index) => {
                            return (
                                <Link key={index} href="/marketing/mentor/single" className="bg-white text-center shadow-sm text-wrap rounded-4 w-100 border card-lift border mentor-card">
                                    <div className="p-3">
